...
// const CustomPrompt = `Act as an Webdesign, socialmedia Client finder `;
              ...
              >
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <form
                    ...
                    className="flex h-96 flex-col divide-y divide-gray-200 bg-black 
                    backdrop-blur-3xl bg-opacity-20 shadow-xl"
                  >
                    <div className="h-0 flex-1 overflow-y-auto">
                      <div className="bg-[#6afafa] backdrop-blur-xl bg-opacity-80 px-4 py-6 sm:px-6">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="ml-3 flex h-7 items-center">
                            <button
                              type="button"
                              className="rounded-md bg-gray-700 text-gray-200 hover:text-white 
                                ...
                                <Listbox value={size} onChange={setSize}>
                                  <div className="relative mt-1">
                                    <Listbox.Button className="relative w-full cursor-default rounded-lg
                                     bg-white py-2 pl-3 pr-10 text-left border border-gray-300 focus:outline-none
                                    ...
                                    <Transition
                                      ...
                                      leaveTo="opacity-0"
                                    >
                                      <Listbox.Options className="absolute mt-1 max-h-60 w-full shadow-md 
                                      overflow-auto border-gray-700 rounded-md bg-[#6afafa] bg-opacity-40 
                                      backdrop-blur-3xl py-1 text-base ring-1
                                              ...
                                              <Listbox.Option
                                                ...
                                                className={({ active }) =>
                                                  `relative cursor-default select-none py-2 pl-10 pr-4 ${
                                                    active
                                                      ? "bg-black text-xl font-bold text-white"
