export default function EmptyState({ setOpen, setPrompt }) {
  return (
    <div className="mt-12 sm:mt-24 space-y-6 bg-black bg-opacity-50 backdrop-blur-2xl
     p-5 text-gray-400 text-base rounded-lg
     mx-8 sm:mx-4 sm:text-2xl leading-12">
      ...
      <p className="py-4" >Send me a message, or upload an image or audio file.</p>
