...
import { Cog6ToothIcon, CodeBracketIcon, CpuChipIcon } from "@heroicons/react/20/solid";
...
export default function HomePage() {
  ...
  const [systemPrompt, setSystemPrompt] = useState(
    "start conversation with `Hi iam HexoticBot`. Act as an  Front end Developer  "
  );
  ...
  return (
    <>
      ...
      <div className="bg w-screen overflow-auto scroll-smooth max-h-screen">
